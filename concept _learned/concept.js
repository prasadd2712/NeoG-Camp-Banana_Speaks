...
// now using document.createtextNode method

var parendiv=document.getElementById('mydiv');

var newTextNode=document.createTextNode('THIS IS THE NEW NODE CREATED');

parendiv.appendChild(newTextNode);

// creating a paragraph and appending it to documnet

const para=document.createElement('textarea');

para.innerText="hello this is textarea using the document.create method";
